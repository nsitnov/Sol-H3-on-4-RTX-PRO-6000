...
def main():
    ...
    patch = str(ROOT / 'patches/sol-h3-image-encoder.patch')
    git('apply', '--check', patch)
    git('apply', patch)
    git('add', '-N', 'models/minimax_h3/Sol-H3/h3_runtime/encoder_tp.py', 'models/minimax_h3/Sol-H3/h3_runtime/encoder_pp.py')
    git('diff', '--check')
